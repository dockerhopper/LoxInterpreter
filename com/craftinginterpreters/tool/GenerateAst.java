...
public class GenerateAst {
    //this isn't part of lox, it's a tool we will use to "hack" the interpreter
    //to generate the syntax tree classes instead of writing 21 different classes in java 
    ...
    //The automated class writer. how elegant with our printwriter class    
    ...
    /*All of that glorious Java boilerplate is done. It declares each field in
    ...
    containing a few dozen lines of code. */
